...
namespace Verdikt\Storelocator\Block;
...
{
    protected $_template = 'Verdikt_Storelocator::center.phtml';
    ...
    {
        $html = $this->setTemplate('Verdikt_Storelocator::left.phtml')->toHtml();
    ...
    public function getLocationCollection()
    {
        ...
        $this->locationCollection->setPageSize(50);
